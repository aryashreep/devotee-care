            ...
            <div class="card-body">
                ...
                <form action="<?php echo url('register', ['step' => $data['step']]); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <?php elseif ($data['step'] == 4): ?>
                        <h4>Step 4: Spiritual Details</h4>
                        <div class="mb-3">
                    ...
                    <?php elseif ($data['step'] == 5): ?>
                        ...
                        <div class="form-check mt-3">
                            <input class="form-check-input" type="checkbox" value="1" id="declaration" name="declaration" required>
                            <label class="form-check-label" for="declaration">
                                I hereby declare that the information furnished above is true and correct to the best of my knowledge. I voluntarily wish to be a part of ISKCON Seshadripuram’s spiritual and seva initiatives. <span class="text-danger">*</span>
                            </label>
                        </div>
                    <?php endif; ?>
